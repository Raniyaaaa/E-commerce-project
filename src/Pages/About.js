    ...
    return (
        <>
            <Container style={{ maxWidth: '800px', marginTop: '2rem',}}>
                <h1 style={{ textAlign: 'center', fontSize: '2.5rem', marginBottom: '1rem' ,fontFamily: 'fantasy',}}>ABOUT</h1>
                <p style={{fontSize:'0.8rem', lineHeight: '1.8', textAlign: 'justify',color:'grey',padding:'1.5rem'}}>
                    <Image
